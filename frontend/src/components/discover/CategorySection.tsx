  ...
  return (
    <section style={{ marginBottom: 48 }}>
      <h2 style={{ fontSize: 18, fontWeight: 600, marginBottom: 16, color: 'var(--text-secondary)' }}>
        {title}
        <span style={{ fontSize: 13, color: 'var(--text-muted)', marginLeft: 8 }}>{tools.length}</span>
      </h2>
      <div style={{
          ...
          return (
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 6 }}>
                <h3 style={{
                  fontSize: 14, fontWeight: 600, color: 'var(--text-heading)', margin: 0,
              ...
              <p style={{
                fontSize: 12, color: 'var(--text-body)', lineHeight: 1.5, margin: '0 0 10px',
